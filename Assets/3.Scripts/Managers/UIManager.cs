...
public class UIManager : ManagerBase
{
    ...
    protected void UnsetUI(UIType wantType)//��� �������� �μ� �˰� �ִ� ���
    {
    ...
    public UIBase SetUI(UIType wantType, UIBase wantUI)
    {
        ...
        if (wantUI == null) return null; // �»󲲼� ���� �� �ʿ�� �Ͻ��� �ʴ±���
    ...
    {
        //Result�� ������ ���� ��!  �������� ġȯ ��Ģ
        //IOpenable�̸� ���� ���ش�! ���� ��Ҵ� �𸣰ڴµ�, ���� ��Ҹ����� �����ϱ�
        //�̰� "�� �� �ִ�"�� �� ��� Ȯ���ұ��?
        //IOpenable���� üũ�غ��� �� �� �ִ��� �� �� �ֽ��ϴ�.
        //IOpenable�μ� Ȱ�� �� �� ������ IOpenable
        //result�� IOpenable�� opener�ΰ�?
